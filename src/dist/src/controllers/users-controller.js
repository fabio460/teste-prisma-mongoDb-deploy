...
const listar = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        res.json(yield (0, users_service_1.listarUser)());
    }
    catch (error) {
        next(error);
    }
...
const listarPorId = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        console.log(id);
        res.json(yield (0, users_service_1.listarUserPorId)(id));
    }
    catch (error) {
        next(error);
    }
...
const criar = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = req.body;
        const id = req.params.id;
        res.json(yield (0, users_service_1.criarUser)(id, user));
    }
    catch (error) {
        next(error);
    }
...
const deletar = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = req.params.id;
        console.log(id);
        res.json(yield (0, users_service_1.deletarUser)(id));
    }
    catch (error) {
        next(error);
    }
...
const atualizar = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const user = req.body;
        res.json(yield (0, users_service_1.atualizarUser)(id, user));
    }
    catch (error) {
